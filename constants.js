...

{
	...
	sesbConstants.actions = {
		check: 'check',
		checkOptionsBlocklistUpdated: 'check-options-blocklist-updated',
		checkOptionsWhitelistUpdated: 'check-options-whitelist-updated',
		clearBlocklist: 'clear-blocklist',
		loadWhitelist: 'load-whitelist',
		loadYourBlocklist: 'load-your-blocklist',
		reloadSettings: 'reload-settings',
		remove: 'remove',
		removeFromWhitelist: 'remove-from-whitelist',
		removeFromWhitelistAndUpdate: 'remove-from-whitelist-and-update',
		unblock: 'unblock',
		update: 'update',
		updateMultiple: 'update-multiple',
		updateSpamLists: 'update-spam-lists',
		whitelistMultiple: 'whitelist-multiple'
	},
